...
test('version settings expose only one-way npm latest updates', () => {
  ...
  assert.match(VERSIONS_VIEW_SOURCE, /runtimeChannel == \.next/)
...
test('runtime update policy defaults to notify and labels failure stages', () => {
  ...
  assert.match(SETTINGS_SOURCE, /runtimeChannel == \.next, autoFollowLatest/)
  assert.match(VERSIONS_VIEW_SOURCE, /更新通道：next/)
